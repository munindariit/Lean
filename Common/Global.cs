...
namespace QuantConnect
{
    ...
    /// <summary>
    /// NSE Derivative Holidays (2010-2019) - Not Tradeable:
    /// </summary>
    public static class NSEHoliday
    {
        /// <summary>
        /// Public Holidays
        /// </summary>
        public static readonly HashSet<DateTime> Dates = new HashSet<DateTime>
        {
            ...
            new DateTime(2010, 1, 26),
            new DateTime(2010, 2, 12),
            new DateTime(2010, 3, 1),
            new DateTime(2010, 3, 24),
            new DateTime(2010, 4, 2),
            new DateTime(2010, 4, 14),
            new DateTime(2010, 9, 10),
            new DateTime(2010, 11, 5),
            new DateTime(2010, 11, 17),
            new DateTime(2010, 12, 17),
            ...
            new DateTime(2011, 8, 15),
            new DateTime(2011, 8, 31),
            new DateTime(2011, 9, 1),
            new DateTime(2011, 10, 6),
            new DateTime(2011, 10, 26),
            new DateTime(2011, 10, 27),
            new DateTime(2011, 11, 7),
            new DateTime(2011, 11, 10),
            new DateTime(2011, 12, 6),
            
            new DateTime(2012, 1, 26),
